...
export default function AppError({
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-6 bg-[#030303] bg-gradient-to-br from-[#0a0514] via-[#050505] to-[#0a0a0a]">
      <div className="max-w-md w-full relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out">
        ...
        <div className="relative bg-[#0a0a0a]/80 backdrop-blur-3xl border border-purple-500/20 p-8 rounded-3xl shadow-2xl flex flex-col items-center text-center">
          ...
          <button
            ...
            disabled={isPending}
            className="w-full h-12 flex items-center justify-center gap-3 bg-purple-600 hover:bg-purple-500 text-white rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_20px_rgba(147,51,234,0.3)] hover:shadow-[0_0_30px_rgba(147,51,234,0.5)] border border-purple-400/50"
          >
